...
print('Hình có chu vi lớn nhất: %f' %max_area)
print('Hình có diện tích lớn nhất: %f ' %max_perimeter)
print('Có %d hình nằm chồng lên nhau nhiều nhất' %max_overlap_count)